...
function getRenderScale() {
  ...
  if (window.matchMedia('(pointer: coarse)').matches) return 0.58;
  if (window.innerWidth >= 1600) return 0.62;
  if (window.innerWidth >= 1200) return 0.72;
  if (window.innerWidth >= 768) return 0.82;
  return 0.7;
}

function syncCanvasDisplay(canvas) {
